...
########################
# Print harbor-0000-core runtime environment
# Arguments:
#   None
# Returns:
#   Boolean
...
########################
# Check if harbor-0000-core is running
# Arguments:
#   None
# Returns:
#   Boolean
...
is_harbor_core_running() {
    # harbor-0000-core does not create any PID file
...
########################
# Check if harbor-0000-core is not running
# Arguments:
#   None
# Returns:
#   Boolean
