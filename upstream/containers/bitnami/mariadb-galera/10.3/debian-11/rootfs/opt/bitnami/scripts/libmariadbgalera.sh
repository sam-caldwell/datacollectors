...
mysql_initialize() {
    ...
    # This fixes an issue where the trap would kill the server_entrypoint.sh, if a PID was left over from a previous run
...
EOF
    debug "Removing all other local-vms for the user"
